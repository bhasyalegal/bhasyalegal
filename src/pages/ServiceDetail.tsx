...
<<<<<<< HEAD
          <div className="mt-16 pt-10 border-t border-[#E5DED0] dark:border-white/10 text-center">
            ...
            <Link
              to="/contact"
              className="group inline-flex items-center gap-2 bg-[#0B1F3A] hover:bg-[#C9A227] text-white hover:text-[#0B1F3A] font-semibold px-8 py-3 rounded-md transition-colors"
            >
              {language === "en" ? "Book a Consultation" : "परामर्श बुक गर्नुहोस्"}
